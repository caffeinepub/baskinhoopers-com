...
import type { Card as _Card, CardId as _CardId, Cart as _Cart, ExternalBlob as _ExternalBlob, StripeSessionStatus as _StripeSessionStatus, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async updateCard(arg0: Card): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateCard(await to_candid_Card_n22(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_opt_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Cart]): Cart | null {
    return value.length === 0 ? null : value[0];
}
...
async function to_candid_Card_n22(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Card): Promise<_Card> {
...
async function to_candid_record_n23(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        stock: value.stock,
        rarity: value.rarity,
        imageId: await to_candid_ExternalBlob_n24(_uploadFile, _downloadFile, value.imageId),
        priceInCents: value.priceInCents
    };
}
